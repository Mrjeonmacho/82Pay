    ...
    switch (_step) {
      case ChangePinStep.verifyCurrentPin:
        ...
        if (isValid) {
          ...
          setState(() {
            _inputPin = "";
            _errorMessage =
                pinProvider.errorMessage ?? 'pin.change.error_invalid_current'.tr();
            _isLoading = false;
          });
        }
        break;
      ...
      case ChangePinStep.confirmNewPin:
        if (_inputPin != _newPin) {
          setState(() {
            _inputPin = "";
            _errorMessage = 'pin.change.error_mismatch'.tr();
          });
          return;
        }
        ...
        if (isUpdated) {
          ...
          setState(() {
            _inputPin = "";
            _errorMessage =
                pinProvider.errorMessage ?? 'pin.change.error_failed'.tr();
            _isLoading = false;
          });
        }
        break;
