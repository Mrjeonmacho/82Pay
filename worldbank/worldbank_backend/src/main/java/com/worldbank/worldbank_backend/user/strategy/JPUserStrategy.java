...
public class JPUserStrategy implements UserStrategy {
    ...
    @Override
    public Optional<UserBankJP> findByEmail(String email) {
    ...
    public void signup(SignupRequest request, String encodedPassword) {
        ...
        while (true) {
            ...
            AccountNumber = "JP" + IntStream.range(0, 12)
        ...
        AccountHistoryJP historyJP = AccountHistoryJP.builder()
